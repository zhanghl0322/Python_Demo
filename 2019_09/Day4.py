...
class ZhaoPinGouLogin(object):
    ...
    def __init__(self, account, password):
        self.url = "https://www.zhaopingou.com/api/security_login_personal?timestamp=1571110779304"
        # https: // www.zhaopingou.com / api / security_login_personal?timestamp = 1571110779304
        self.headers = {
